<?php
/**
* Template Name: For Healthcare Person
*
* @package WordPress
			...
			<div class="container">
				...
				<div class="row justify-content-center">
					...
					<div class="col-md-5 text-center">
						...
						<a class="btn btn-primary btn-lg w-100 mb-4" href="/healthcare-registration/">Register Now</a>
						
						<h3 class="fw-bold mb-3">Already Have an Account?</h3>
						<a class="btn btn-outline-primary btn-lg w-100" href="/healthcare-login/">Login</a>
					</div>
